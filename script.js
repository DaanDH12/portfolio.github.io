...
function fetchSheetData() {
  gapi.client.sheets.spreadsheets.values.get({
    ...
    var textFragments = ['Elke keer als je een avond niet gedronken hebt, vult de progressbar hieronder zich! Als die helemaal vol zit zul je rijkelijk beloond worden Tim!', 'Tekstfragment 2', 'Tekstfragment 3']; // Voeg hier de verschillende tekstfragmenten toe
